...
class NeuralNetwork:
    ...
    def fit(self, input_list, target_list):
        ...
        self.who += self.lr * np.dot((output_error * final_outputs * (1.0 - final_outputs)), np.transpose(inputs))
...
if __name__ == '__main__':
    ...
    # 신경망 생성
    nn = NeuralNetwork(INPUT_NODE, HIDDEN_NODE, OUTPUT_NODE, learning_rate)
